...
// Comprehensive legitimate language code mapping
// Based on ISO 639-1, ISO 639-2, ISO 639-3, and established linguistic codes
const getLanguageName = (code: string): string => {
  const names: { [key: string]: string } = {
    ...
    // === HISTORICAL AND RECONSTRUCTED LANGUAGES ===
    'la': 'Latin',
    'grc': 'Ancient Greek',
    'got': 'Gothic',
    'non': 'Old Norse',
    ...
    'gmq-pro': 'Proto-North Germanic',
    'gme-pro': 'Proto-East Germanic',
    ...
    'pce-pro': 'Proto-Central-Eastern Malayo-Polynesian',
    'poc-pro': 'Proto-Oceanic',
    ...
    'kox-pro': 'Proto-Koreanic',
    'nic-pro': 'Proto-Niger-Congo',
    'bnt-pro': 'Proto-Bantu',
    'omv-pro': 'Proto-Omotic',
    'cus-pro': 'Proto-Cushitic',
    'ber-pro': 'Proto-Berber',
    'chd-pro': 'Proto-Chadic',
    'nai-pro': 'Proto-North American Indian',
    'sai-pro': 'Proto-South American Indian',
    'cai-pro': 'Proto-Central American Indian',
    'esx-pro': 'Proto-Eskimo-Aleut',
    'ypk-pro': 'Proto-Yupik',
    'aus-pro': 'Proto-Australian',
    'pny-pro': 'Proto-Pama-Nyungan',
  ...
  // Return the mapped name if it exists, otherwise reject with "Unknown"
  ...
  useEffect(() => {
    ...
    if (!containerRef.current) {
      ...
      simulationRef.current = d3.forceSimulation<D3Node, D3Link>()
        ...
        .force('collision', d3.forceCollide().radius((d: any) => d.radius + 20).strength(0.8))
